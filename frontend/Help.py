...
def create_help_page(parent, show_home_callback):
    ...
    help_text = (
        ...
        ".tif, and .mp4.\n\n"
        "Next, choose the effect that you would like to apply to your file. If you choose the polygonize "
        "effect, you have the option to customize the number of polygons and amount of color reduction in "
        "your final product. Keep in mind that the larger these values are, the longer it will take to process.\n\n"
        "Finally, a preview will be generated and you will have the option to download the file. If you don’t "
        "like how it looks, you will have the option to adjust effects and values, or upload a completely new "
        "file to edit."
    )
